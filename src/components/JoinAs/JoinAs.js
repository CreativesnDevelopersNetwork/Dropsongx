import "./join.css";
import djside from "../../assets/djCover.jpg";
import artistside from "../../assets/djSide/images/music photos/music1.jpg";
...
const JoinAs = () => {
    return(
      ...
      <div className="card-grid">
        ...
        <div className="card__background" style={{ backgroundImage: `url(${artistside})` }}></div>
        ...
        <div className="card__background" style={{ backgroundImage: `url(${djside})` }}></div>
  <div className="card__content">
